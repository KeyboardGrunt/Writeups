...
![alt text](https://github.com/KeyboardGrunt/Writeups/blob/main/Pasted%20image%2020250718193536.png "web source")

At the very end of this JS file we can see a comment referring to a "test-main.min.js.map" file.
![alt text](https://github.com/KeyboardGrunt/Writeups/blob/main/Pasted%20image%2020250718193658.png "test file reference")

This file has a section in the "sourcesContent" key which looks like this when formatted a bit:
![alt text](https://github.com/KeyboardGrunt/Writeups/blob/main/Pasted%20image%2020250718194127.png "test file content")
...
![alt text](https://github.com/KeyboardGrunt/Writeups/blob/main/Pasted%20image%2020250718194611.png "test file content")
